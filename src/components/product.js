...
const Product = ({items,updatecart}) => {
  ...
  return (
    <div style={{boxShadow: '2px 2px 5px 2px rgba(0, 0, 0, 0.15)',color:`black`,backgroundColor:`white`}} className={` border-2 my-2 relative min-w-[200px]  max-w-full h-full   max-md:w-[20%]   rounded-[20px]`}>
